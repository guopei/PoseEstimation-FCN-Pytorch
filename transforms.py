...
__all__ = ["Compose", "ToTensor", "Normalize", "Resize", "ResizeTarget", "Scale", "CenterCrop",
           "Lambda", "RandomCrop", "RandomHorizontalFlip", "RandomVerticalFlip", "RandomResizedCrop",
           "RandomSizedCrop",  "ColorJitter", "RandomRotation"]
...
class ToPILImage(object):
    ...
    def __call__(self, sample):
        ...
        """
        return F.to_pil_image(sample, self.mode)
...
class ResizeTarget(object):
    ...
    def __call__(self, sample):
        ...
        """
        return F.resize_target(sample, self.size, self.interpolation)
